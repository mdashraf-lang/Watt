...
export default function SplashScreen() {
  ...
  const slides = [
    { id: '1', emoji: '⚡', title: t.splash_slide1_title, subtitle: t.splash_slide1_sub },
    { id: '2', emoji: '📍', title: t.splash_slide2_title, subtitle: t.splash_slide2_sub },
    { id: '3', emoji: '💳', title: t.splash_slide3_title, subtitle: t.splash_slide3_sub },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.logoArea}>
        ...
        <Text style={styles.logoSubText}>{t.app_tagline}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  logoArea: { alignItems: 'center', paddingTop: 80, paddingBottom: 24 },
  ...
  logoText: { fontSize: 36, fontWeight: '800', color: '#FFFFFF', letterSpacing: 6 },
  logoSubText: { fontSize: 13, color: 'rgba(255,255,255,0.7)', marginTop: 4 },
  slide: { alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32 },
  slideEmoji: { fontSize: 72, marginBottom: 24 },
  slideTitle: { fontSize: 24, fontWeight: '700', color: '#FFFFFF', textAlign: 'center', marginBottom: 12 },
  slideSubtitle: { fontSize: 15, color: 'rgba(255,255,255,0.75)', textAlign: 'center', lineHeight: 22 },
  dots: { flexDirection: 'row', gap: 8, marginBottom: 32 },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: 'rgba(255,255,255,0.3)' },
  dotActive: { width: 24, backgroundColor: COLORS.gold },
  footer: { width: '100%', paddingHorizontal: 24, paddingBottom: 48, gap: 12 },
  button: { backgroundColor: COLORS.gold, borderRadius: 16, paddingVertical: 16, alignItems: 'center' },
  buttonText: { fontSize: 17, fontWeight: '700', color: '#0F172A' },
